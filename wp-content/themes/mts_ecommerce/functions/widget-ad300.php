...
function __construct() {
	...
	$widget_ops = array(
		...
		'description' => __('A widget for 300 x 250 ad (Single banner)', MTS_THEME_TEXTDOMAIN )
	);
	...
	// Create the widget
	parent::__construct( 'mts_ad_300_widget', __('MyThemeShop: 300x250 Ad', MTS_THEME_TEXTDOMAIN ), $widget_ops, $control_ops );
