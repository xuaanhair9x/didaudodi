...
function mts_add_sidebar_metabox() {
    ...
    foreach ($screens as $screen) {
        add_meta_box(
            ...
            __('Sidebar', MTS_THEME_TEXTDOMAIN ),    // title
...
function mts_inner_sidebar_metabox($post) {
    ...
    */
    ...
    echo '<option value="" '.selected('', $custom_sidebar).'>-- '.__('Default', MTS_THEME_TEXTDOMAIN ).' --</option>';
    ...
    echo '<option value="mts_nosidebar" '.selected('mts_nosidebar', $custom_sidebar).'>-- '.__('No sidebar --', MTS_THEME_TEXTDOMAIN ).'</option>';    
    echo '</select><br />';
    
    // Select single layout (left/right sidebar)
    echo '<div class="mts_sidebar_location_fields">';
    echo '<label for="mts_sidebar_location_default" style="display: inline-block; margin-right: 20px;"><input type="radio" name="mts_sidebar_location" id="mts_sidebar_location_default" value=""'.checked('', $sidebar_location, false).'>'.__('Default side', MTS_THEME_TEXTDOMAIN ).'</label>';
    echo '<label for="mts_sidebar_location_left" style="display: inline-block; margin-right: 20px;"><input type="radio" name="mts_sidebar_location" id="mts_sidebar_location_left" value="left"'.checked('left', $sidebar_location, false).'>'.__('Left', MTS_THEME_TEXTDOMAIN ).'</label>';
    echo '<label for="mts_sidebar_location_right" style="display: inline-block; margin-right: 20px;"><input type="radio" name="mts_sidebar_location" id="mts_sidebar_location_right" value="right"'.checked('right', $sidebar_location, false).'>'.__('Right', MTS_THEME_TEXTDOMAIN ).'</label>';
    echo '</div>';
...
function mts_add_posttemplate_metabox() {
    add_meta_box(
        ...
        __('Template', MTS_THEME_TEXTDOMAIN ),      // title
...
function mts_inner_posttemplate_metabox($post) {
    ...
    */
    ...
    echo '<option value="" '.selected('', $posttemplate).'>'.__('Default Post Template', MTS_THEME_TEXTDOMAIN ).'</option>';
    echo '<option value="parallax" '.selected('parallax', $posttemplate).'>'.__('Parallax Template', MTS_THEME_TEXTDOMAIN ).'</option>';
    echo '<option value="zoomout" '.selected('zoomout', $posttemplate).'>'.__('Zoom Out Effect Template', MTS_THEME_TEXTDOMAIN ).'</option>';
    echo '</select><br />';
}
...
function mts_add_postheader_metabox() {
    ...
    foreach ($screens as $screen) {
        add_meta_box(
            ...
            __('Header Animation', MTS_THEME_TEXTDOMAIN ),    // title
...
function mts_inner_postheader_metabox($post) {
    ...
    */
    ...
    echo '<option value="" '.selected('', $postheader).'>'.__('None', MTS_THEME_TEXTDOMAIN ).'</option>';
    echo '<option value="parallax" '.selected('parallax', $postheader).'>'.__('Parallax Effect', MTS_THEME_TEXTDOMAIN ).'</option>';
    echo '<option value="zoomout" '.selected('zoomout', $postheader).'>'.__('Zoom Out Effect', MTS_THEME_TEXTDOMAIN ).'</option>';
    echo '</select><br />';
}
