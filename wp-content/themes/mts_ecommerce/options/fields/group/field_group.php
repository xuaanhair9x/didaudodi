...
class NHP_Options_group extends NHP_Options{	
	...
	*/
	function render(){
		...
		echo '<div class="nhp-opts-groups-accordion-group nhp-opts-dummy" style="display:none" id="nhp-opts-dummy-' . $this->field['id'] . '"><h3><span class="nhp-opts-groups-header">' . __("New ", MTS_THEME_TEXTDOMAIN) . $this->field['groupname'] . '</span></h3>';
