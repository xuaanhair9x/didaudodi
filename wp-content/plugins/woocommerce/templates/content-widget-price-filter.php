...
<!--			<button type="submit" class="button">--><?php //echo esc_html__( 'Filter', 'woocommerce' ); ?><!--</button>-->
			<div class="price_label row" style="display:none;">
				<span class="from col-sm-4 col-xs-4"></span> <span class="col-sm-4 col-xs-4">Tới</span> <span class="to col-sm-4 col-xs-4"></span>
			</div>
